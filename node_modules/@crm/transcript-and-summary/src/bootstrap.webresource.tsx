...
export default {
  ...
  CallLogPage: require('./components/CallLogPage').default,
  CallDetailPage: require('./components/CallDetailPage').default,
  ConversationTranscript: require('./components/ConversationTranscript').ConversationTranscript,
  SummaryPanel: require('./components/SummaryPanel').default,
};
